# Regenerate logo with tight bounding box for maximum visibility and size, 100% transparent background

svg_code = '''<svg xmlns="http://www.w3.org/2000/svg" viewBox="75 35 430 310" width="100%" height="100%">
  <defs>
    <style>
      .cls-blue { fill: #007BFF; }
      .cls-orange { fill: #FF7A00; }
      .cls-line { stroke: #007BFF; stroke-width: 4.5; stroke-linecap: round; }
      .cls-panel {
  ...
  <g filter="url(#crisp-shadow)">
    ...
    <g id="icon-m">
      ...
      <rect class="cls-orange" x="308" y="162" width="22" height="50" rx="6" />

      <!-- Orange Cellular Signal / Growth Bar 2 (Medium) -->
      <rect class="cls-orange" x="340" y="132" width="24" height="80" rx="6" />

      <!-- Orange Cellular Signal / Growth Bar 3 (Tall, matching outer slope) -->
      <path class="cls-orange" d="
        M 374,96
    ...
    <g id="typography-mmba">
      ...
      <rect class="cls-orange" x="427" y="264" width="28" height="20" rx="4" />
    </g>

    <!-- ==================== SUBTITLE — PANEL — ==================== -->
    <g id="panel-rule">
      <line class="cls-line" x1="104" y1="328" x2="176" y2="328" />
      <text class="cls-panel" x="300" y="337" text-anchor="middle">PANEL</text>
      <line class="cls-line" x1="404" y1="328" x2="476" y2="328" />
    </g>
  </g>
</svg>
'''
...
print("Updated public/logo.svg and dist/logo.svg with tight transparent viewBox!")
