      ...
      <div className="w-full space-y-1.5">
        ...
        <div className="relative flex items-center">
          ...
          <input
            ...
            ref={ref}
            className={cn(
              'w-full rounded-xl bg-(--bg-surface) border border-(--border-subtle) text-(--text-primary) text-sm px-3.5 py-2.5 transition-all duration-200 placeholder:text-slate-400 dark:placeholder:text-slate-500 focus:outline-none focus:border-(--border-focus) focus:ring-2 focus:ring-indigo-500/20 disabled:opacity-50 disabled:bg-slate-100 dark:disabled:bg-slate-950',
              visualLeft ? 'ps-10' : '',
              visualRight ? 'pe-10' : '',
